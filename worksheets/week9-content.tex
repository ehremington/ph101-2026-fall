...
\item Two objects collide elastically. One has a mass of \SI{1}{kg} and the second has a mass of \SI{3}{kg}. The first object is traveling to the right at a speed of \SI{3}{m/s}. With what velocity would the second object need to be traveling so that after the collision, the first object was motionless?
